...
module SteamCondenser::Community
  ...
  class GameStats
    ...
    def self.create_game_stats(steam_id, game_name)
      case game_name
        when 'alienswarm'
          require 'steam-condenser/community/alien_swarm/alien_swarm_stats'
          AlienSwarmStats.new(steam_id)
        when 'cs:s'
          require 'steam-condenser/community/css/css_stats'
          CSSStats.new(steam_id)
        when 'defensegrid:awakening'
          require 'steam-condenser/community/defense_grid/defense_grid_stats'
          DefenseGridStats.new(steam_id)
        when 'dod:s'
          require 'steam-condenser/community/dods/dods_stats'
          DoDSStats.new(steam_id)
        when 'l4d'
          require 'steam-condenser/community/l4d/l4d_stats'
          L4DStats.new(steam_id)
        when 'l4d2'
          require 'steam-condenser/community/l4d/l4d2_stats'
          L4D2Stats.new(steam_id)
        when 'portal2'
          require 'steam-condenser/community/portal2/portal2_stats'
          Portal2Stats.new steam_id
        when 'tf2'
          require 'steam-condenser/community/tf2/tf2_stats'
